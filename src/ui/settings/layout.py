"""固定 GUI 布局尺寸。 / Fixed GUI layout dimensions."""
...
FORM_SECOND_LABEL_WIDTH = 124
FORM_SECOND_FIELD_WIDTH = 374
FIELD_ROW_HEIGHT = 70
BUTTON_BAR_HEIGHT = 64
RUN_ACTION_BUTTON_WIDTH = 220
RUN_ACTION_PROGRESS_WIDTH = 674
RUN_ACTION_GAP = 16
RUN_ACTION_ROW_WIDTH = RUN_ACTION_BUTTON_WIDTH + RUN_ACTION_GAP + RUN_ACTION_PROGRESS_WIDTH
TRAINING_PLATFORM_RESULT_HEIGHT = 82

GAME_CONTROLS_HEIGHT = 276
GAME_STATUS_HEIGHT = 96
