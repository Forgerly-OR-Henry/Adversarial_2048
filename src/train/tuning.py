...
from evaluation.compare import EvaluationStats, evaluate_training_artifact, identify_training_artifact
from train.train_enemy_q import train_q_enemy
...
def _train_candidate(
    *,
    ...
    if target == "player":
        from train.train_player_dqn import train_dqn_player
    ...
    from train.train_enemy_dqn import train_dqn_enemy
