...
from train.train_enemy_q import EnemyTrainingSummary, train_q_enemy
from train.train_player_q import TrainingSummary, train_q_player

if TYPE_CHECKING:
    from train.merge import MergeSummary
    from train.tuning import TuningCandidate, TuningResult
    from train.train_enemy_dqn import EnemyDQNTrainingSummary
    from train.train_player_dqn import DQNTrainingSummary


def list_training_artifacts(*args, **kwargs):
    """列出历史训练产物。 / List historical training artifacts."""
    from train.artifacts import list_training_artifacts as _list_training_artifacts
...
def merge_training_artifacts(*args, **kwargs):
    ...
    from train.merge import merge_training_artifacts as _merge_training_artifacts
...
def generate_tuning_candidates(*args, **kwargs):
    ...
    from train.tuning import generate_tuning_candidates as _generate_tuning_candidates
...
def run_auto_tuning(*args, **kwargs):
    ...
    from train.tuning import run_auto_tuning as _run_auto_tuning
...
def train_dqn_enemy(*args, **kwargs):
    ...
    from train.train_enemy_dqn import train_dqn_enemy as _train_dqn_enemy
...
def train_dqn_player(*args, **kwargs):
    ...
    from train.train_player_dqn import train_dqn_player as _train_dqn_player
...
def __getattr__(name: str):
    ...
    if name == "TuningCandidate":
        from train.tuning import TuningCandidate

        return TuningCandidate
    if name == "TuningResult":
        from train.tuning import TuningResult
